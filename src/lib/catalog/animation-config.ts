...
export const ANIM_SOURCE_MODES: ReadonlyArray<{
...
}> = [
  {
    ...
    shortLabel: "À partir de zéro",
    perSecondEur: 15,
    description: "Nous construisons le modèle 3D et l’animation — à partir de croquis ou de références photo.",
  },
  {
    id: "existing",
    label: "Animation (modèle existant)",
    shortLabel: "Modèle existant",
    perSecondEur: 10,
    description: "Vous disposez déjà d’un modèle 3D — nous créons l’animation à partir de celui-ci.",
  },
  {
    id: "active",
    label: "Animation (projet en cours)",
    shortLabel: "Projet en cours",
    perSecondEur: 8,
    description: "Vous avez un projet de rendu en cours chez nous — nous utilisons le même modèle.",
  },
];
...
export const ANIM_TYPES = [
  { id: "exterior", label: "Extérieur (survol)" },
  { id: "interior", label: "Intérieur (visite)" },
  { id: "combined", label: "Combiné (extérieur + intérieur)" },
] as const;
...
export const ANIM_TIMES_OF_DAY = [
  { id: "daylight", label: "Jour (ensoleillé)" },
  { id: "golden-hour", label: "Heure dorée (coucher de soleil)" },
  { id: "dusk-night", label: "Crépuscule / Nuit (éclairages allumés)" },
  { id: "overcast", label: "Couvert / Atmosphérique" },
] as const;
...
export const ANIM_SEASONS = [
  { id: "summer-spring", label: "Été / Printemps (verdure)" },
  { id: "autumn", label: "Automne (feuilles jaunes)" },
  { id: "winter", label: "Hiver (neige)" },
] as const;
...
export const ANIM_CAMERA_SPEEDS = [
  { id: "slow", label: "Lente / cinématique (accent sur les détails)" },
  { id: "medium", label: "Moyenne (visite standard)" },
  { id: "fast", label: "Rapide / dynamique (vue d’ensemble de l’espace)" },
] as const;
...
export const ANIM_MUSIC_MOODS = [
  { id: "no-music", label: "Sans musique" },
  { id: "relaxing", label: "Relaxante / Ambiante" },
  { id: "dynamic", label: "Dynamique / Moderne" },
  { id: "corporate", label: "Corporate / Présentation" },
] as const;
...
export const ANIM_FOCUS_AREA_OPTIONS = [
  { key: "architecture", label: "Architecture / Façade" },
  { key: "interior", label: "Design d’intérieur" },
  { key: "landscape", label: "Paysage / Cour" },
  { key: "amenities", label: "Équipements du complexe (piscines, parcs)" },
] as const;
...
export const ANIM_SCENE_ELEMENT_OPTIONS = [
  { key: "people", label: "Personnages en mouvement (silhouettes 3D)" },
  { key: "cars", label: "Voitures en mouvement" },
  { key: "waterTrees", label: "Eau animée / arbres dans le vent" },
] as const;
