/**
 * /commande/echec — PayPal payment failure / decline landing.
 *
 * Mirror of /commande/succes for declined or failed PayPal payments
...
export default async function CheckoutFailurePage({ searchParams }: PageProps) {
  ...
  if (order.paymentStatus === "completed") {
    redirect(`/commande/succes?orderId=${order.id}`);
  }
