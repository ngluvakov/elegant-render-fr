...
export const AI_STYLE_OPTIONS: AiStyleOption[] = [
  ...
  { id: "coastal", label: "Coastal", image: "/styles/coastal.webp" },
];
...
export const AI_EDIT_TYPES: AiEditTypeDefinition[] = [
  {
    ...
    complexity: "simple",
    units: 1,
    description: "Removes objects, clutter, people, vehicles or small distractions from a photograph.",
    supportsMask: true,
    multiSelect: true,
    promptPlaceholder: "e.g. remove the traffic signs and bags; careful with the shadows on the wall",
    optionsLabel: "What to remove (multiple allowed)",
    options: [
      { id: "furniture", label: "Furniture" },
      { id: "clutter", label: "Clutter and small items" },
      { id: "vehicles", label: "Vehicles" },
      { id: "people", label: "People" },
      { id: "surfaces", label: "Marks on walls/floors" },
    ],
  },
  {
    id: "day_to_dusk",
    ...
    complexity: "simple",
    units: 1,
    description: "Turns a daylight photograph into an evening or dusk view.",
    supportsMask: false,
    promptPlaceholder: "e.g. keep the natural lighting on the facade, subtle window glow",
    optionsLabel: "Atmosphere",
    options: [
      { id: "warm-dusk", label: "Warm dusk" },
      { id: "blue-hour", label: "Blue hour" },
      { id: "evening-lights", label: "Evening lights" },
      { id: "luxury-night", label: "Luxury night look" },
      { id: "real-estate", label: "Realistic real-estate edit" },
    ],
  },
  {
    id: "sky_replacement",
    ...
    complexity: "simple",
    units: 1,
    description: "Replaces a gray or overcast sky with a more attractive atmosphere.",
    supportsMask: false,
    promptPlaceholder: "e.g. soft lighting, subtle clouds, do not change the building color",
    optionsLabel: "Sky",
    options: [
      { id: "clear-blue", label: "Clear blue" },
      { id: "soft-clouds", label: "Soft clouds" },
      { id: "golden-hour", label: "Golden hour" },
      { id: "dramatic", label: "Dramatic sky" },
      { id: "sunset", label: "Sunset" },
    ],
  },
  {
    id: "wall_color_change",
    label: "Wall color change",
    shortLabel: "Wall color",
    complexity: "simple",
    units: 1,
    description: "Quick wall color change with a color picker and extra instructions.",
    supportsColor: true,
    supportsMask: true,
    promptPlaceholder: "e.g. keep the trim and frame colors, do not touch the furniture",
  },
  {
    id: "virtual_staging",
    ...
    complexity: "complex",
    units: 2,
    description: "Adds furniture and decor to an empty or sparsely furnished room.",
    supportsStyles: true,
    supportsMask: true,
    promptPlaceholder: "e.g. warm modern furniture, wood flooring, keep the windows and lighting",
    optionsLabel: "Room type",
    options: [
      ...
      { id: "terrace", label: "Terrace/exterior" },
      { id: "other", label: "Other" },
    ],
  },
  {
    id: "object_insertion",
    label: "Furniture/decor insertion or replacement",
    shortLabel: "Furniture/decor replace",
    complexity: "complex",
    units: 2,
    description:
      "Adds or replaces furniture, decor, lighting, plants, artwork or appliances while matching perspective, light and shadows.",
    supportsMask: true,
    requiresReferenceImage: true,
    promptPlaceholder:
      "e.g. place the armchair next to the window or replace the existing chair; keep the rest of the room",
    optionsLabel: "Item type",
    options: [
      { id: "furniture", label: "Furniture" },
  ...
  },
  {
    ...
    complexity: "complex",
    units: 2,
    description: "Changes materials, floors, walls, kitchen, bathroom or the entire look.",
    supportsStyles: true,
    supportsMask: true,
    promptPlaceholder: "e.g. replace the floor with oak parquet, keep the kitchen layout",
    optionsLabel: "What to change",
    options: [
  ...
  },
  {
    ...
    complexity: "complex",
    units: 2,
    description: "Changes the style, atmosphere and visual identity of an existing room.",
    supportsStyles: true,
    supportsMask: true,
    promptPlaceholder: "e.g. light Scandinavian style, keep the orientation and windows",
    optionsLabel: "Room type",
    options: [
      { id: "living-room", label: "Living room" },
      { id: "bedroom", label: "Bedroom" },
