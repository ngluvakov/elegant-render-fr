...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: SitemapEntry[] = [
    ...
    { path: "/informations-legales", changeFrequency: "yearly", priority: 0.5 },
    { path: "/informations-legales/mentions-legales", changeFrequency: "yearly", priority: 0.45 },
    { path: "/informations-legales/certificats", changeFrequency: "yearly", priority: 0.55 },
    { path: "/informations-legales/cgv", changeFrequency: "yearly", priority: 0.35 },
    { path: "/informations-legales/confidentialite", changeFrequency: "yearly", priority: 0.35 },
    { path: "/informations-legales/remboursements", changeFrequency: "yearly", priority: 0.35 },
    { path: "/informations-legales/retractation", changeFrequency: "yearly", priority: 0.35 },
    { path: "/informations-legales/reclamations", changeFrequency: "yearly", priority: 0.35 },
    { path: "/informations-legales/livraison", changeFrequency: "yearly", priority: 0.35 },
    { path: "/informations-legales/cookies", changeFrequency: "yearly", priority: 0.35 },
