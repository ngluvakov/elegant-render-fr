 ...
 * discover the next discount tier, then jumps straight into
 * /portal/nova-porudzbina with the quote pre-loaded into sessionStorage
 * (same path PortalCreditSummary uses on the portal-side picker).
 */
