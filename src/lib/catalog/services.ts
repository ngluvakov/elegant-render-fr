    ...
    portfolioImages: [
      {
        ...
        alt: "3D streetscape — row of contemporary terraced houses, street perspective with cars and greenery, Elegant Render",
        beforeSrc: "/artwork/portfolio-streetscape-street-01-before.webp",
        beforeAlt: "Black-and-white technical 2D plan of the same street row with plots, the sidewalk and the road",
      },
      {
        src: "/artwork/portfolio-streetscape-street-02.webp",
        alt: "3D streetscape — contemporary buildings in a street row from a pedestrian perspective, Elegant Render",
        beforeSrc: "/artwork/portfolio-streetscape-street-02-before.webp",
        beforeAlt: "Black-and-white technical 2D plan of the same street before the 3D view",
      },
      {
        src: "/artwork/portfolio-streetscape-street-03.webp",
        alt: "3D streetscape — buildings along the street with landscaped greenery, street perspective, Elegant Render",
        beforeSrc: "/artwork/portfolio-streetscape-street-03-before.webp",
        beforeAlt: "Black-and-white technical 2D plan of the same street with the building layout",
      },
      {
        src: "/artwork/portfolio-streetscape-street-04.webp",
        alt: "3D streetscape — row of neighboring buildings in a street context, Elegant Render",
        beforeSrc: "/artwork/portfolio-streetscape-street-04-before.webp",
        beforeAlt: "Black-and-white technical 2D plan of the same street row with building labels",
      },
    ],
    faqs: [
      {
    ...
    portfolioImages: [
      {
        ...
        alt: "Virtual staging — bedroom with warm materials and furniture",
        beforeSrc: "/artwork/portfolio-virtual-staging-stg-01-before.webp",
        beforeAlt: "An empty room before virtual staging — no furniture or decoration",
      },
      {
        src: "/artwork/portfolio-virtual-staging-stg-02.webp",
        alt: "Virtual staging — styled room with furniture and decoration",
        beforeSrc: "/artwork/portfolio-virtual-staging-stg-02-before.webp",
        beforeAlt: "An empty room before virtual staging — bare walls and no furniture",
      },
      {
        src: "/artwork/portfolio-virtual-staging-stg-03.webp",
        alt: "Virtual staging — interior with furniture and natural light",
        beforeSrc: "/artwork/portfolio-virtual-staging-stg-03-before.webp",
        beforeAlt: "An empty room before virtual staging — no furniture",
      },
      {
        src: "/artwork/portfolio-virtual-staging-stg-04.webp",
        alt: "Virtual staging — furnished room with furniture and decoration",
        beforeSrc: "/artwork/portfolio-virtual-staging-stg-04-before.webp",
        beforeAlt: "An empty room before virtual staging — bare floor and walls",
      },
    ],
    variants: [
      {
    ...
    portfolioImages: [
      {
        ...
        alt: "Virtual renovation — renovated bathroom with a glass shower and tiling",
        beforeSrc: "/artwork/portfolio-virtual-renovation-reno-01-before.webp",
        beforeAlt: "The room before renovation — unfinished works with bare walls and floor",
      },
      {
        src: "/artwork/portfolio-virtual-renovation-reno-02.webp",
        alt: "Virtual renovation — renovated interior with new materials",
        beforeSrc: "/artwork/portfolio-virtual-renovation-reno-02-before.webp",
        beforeAlt: "The room before renovation — a worn interior before the makeover",
      },
      {
        src: "/artwork/portfolio-virtual-renovation-reno-03.webp",
        alt: "Virtual renovation — renovated room with new floors and warm materials",
        beforeSrc: "/artwork/portfolio-virtual-renovation-reno-03-before.webp",
        beforeAlt: "The room before renovation — an unfinished space before the makeover",
      },
      {
        src: "/artwork/portfolio-virtual-renovation-reno-04.webp",
        alt: "Virtual renovation — refreshed room with new materials and lighting",
        beforeSrc: "/artwork/portfolio-virtual-renovation-reno-04-before.webp",
        beforeAlt: "The room before renovation — bare walls and floor before the makeover",
      },
    ],
    variants: [
      {
    ...
    portfolioImages: [
      {
        ...
        alt: "3D floor plan of an apartment — photoreal view of the layout with furniture and materials from a bird's-eye perspective, Elegant Render",
        beforeSrc: "/artwork/portfolio-3d-floor-plans-apartment-01-before.webp",
        beforeAlt: "Black-and-white technical 2D floor plan of the same apartment with dimensions and room labels",
      },
      {
        src: "/artwork/portfolio-3d-floor-plans-apartment-02.webp",
        alt: "3D floor plan of an apartment — 3D view of the layout and furniture, top-down view, Elegant Render",
        beforeSrc: "/artwork/portfolio-3d-floor-plans-apartment-02-before.webp",
        beforeAlt: "Black-and-white technical 2D floor plan of the same apartment before the 3D view",
      },
      {
        src: "/artwork/portfolio-3d-floor-plans-apartment-03.webp",
        alt: "3D floor plan of an apartment — photoreal 3D floor plan with furniture and materials, Elegant Render",
        beforeSrc: "/artwork/portfolio-3d-floor-plans-apartment-03-before.webp",
        beforeAlt: "Black-and-white technical 2D floor plan of the same apartment with dimensions",
      },
      {
        src: "/artwork/portfolio-3d-floor-plans-apartment-04.webp",
        alt: "3D floor plan of an apartment — 3D view of the room layout and furniture from a bird's-eye perspective, Elegant Render",
        beforeSrc: "/artwork/portfolio-3d-floor-plans-apartment-04-before.webp",
        beforeAlt: "Black-and-white technical 2D floor plan of the same apartment with room labels",
      },
    ],
    faqs: [
      {
    ...
    portfolioImages: [
      {
        ...
        beforeAlt: "An unlandscaped yard before the design — leveled ground without greenery",
      },
      {
        ...
        beforeAlt: "An unlandscaped shared space before the design — bare ground without planting",
      },
      {
        ...
        beforeAlt: "An unlandscaped villa yard before the design — empty ground before planting",
      },
      {
        ...
        beforeAlt: "An unlandscaped public space before the design — leveled ground without greenery",
      },
    ],
    pricingLead: {
    ...
    portfolioImages: [
      {
        ...
        alt: "Photomontage — finished family house blended into a real street photo, Elegant Render",
        beforeSrc: "/artwork/portfolio-photomontage-real-01-before.webp",
        beforeAlt: "The real photo of the site before the montage — a building under construction behind a site fence",
      },
      {
        src: "/artwork/portfolio-photomontage-real-02.webp",
        alt: "Photomontage — finished residential building blended into a real street photo, Elegant Render",
        beforeSrc: "/artwork/portfolio-photomontage-real-02-before.webp",
        beforeAlt: "The real photo of the site before the montage — a building under construction in a street row",
      },
      {
        src: "/artwork/portfolio-photomontage-real-03.webp",
        alt: "Photomontage — finished building blended into a real photo of the street, Elegant Render",
        beforeSrc: "/artwork/portfolio-photomontage-real-03-before.webp",
        beforeAlt: "The real photo of the site before the montage — a building under construction",
      },
      {
        src: "/artwork/portfolio-photomontage-real-04.webp",
        alt: "Photomontage — finished building blended into a real photo of the surroundings, Elegant Render",
    ...
    portfolioImages: [
      {
        ...
        alt: "3D site plan — aerial view of a residential complex with 3 buildings, a shared space and parking zones, Elegant Render",
        beforeSrc: "/artwork/portfolio-3d-site-plan-sp-01-before.webp",
        beforeAlt: "Black-and-white technical 2D site plan of the same complex with labels and building positions",
      },
      {
        src: "/artwork/portfolio-3d-site-plan-sp-02.webp",
        alt: "3D site plan of a residential development — aerial 3D view of the buildings, greenery and roads, Elegant Render",
        beforeSrc: "/artwork/portfolio-3d-site-plan-sp-02-before.webp",
        beforeAlt: "Black-and-white technical 2D site plan of the same development before the 3D view",
      },
      {
        src: "/artwork/portfolio-3d-site-plan-sp-03.webp",
        alt: "3D site plan of a family-house neighborhood — aerial 3D view of the plots, yards and access roads, Elegant Render",
        beforeSrc: "/artwork/portfolio-3d-site-plan-sp-03-before.webp",
        beforeAlt: "Black-and-white technical 2D site plan of the neighborhood with the layout of plots and houses",
      },
      {
        src: "/artwork/portfolio-3d-site-plan-sp-04.webp",
        alt: "3D site plan of a complex — photoreal aerial 3D view of the buildings and landscaping, Elegant Render",
        beforeSrc: "/artwork/portfolio-3d-site-plan-sp-04-before.webp",
        beforeAlt: "Black-and-white technical 2D site plan of the same complex with building labels",
      },
    ],
    variants: [
      {
    ...
    portfolioImages: [
      {
        ...
        alt: "Day-to-dusk — family house with lit windows and facade lighting at dusk",
        beforeSrc: "/artwork/portfolio-day-to-dusk-dn-01-before.webp",
        beforeAlt: "The daytime view of the same house — the facade in daylight under a clear sky",
      },
      {
        src: "/artwork/portfolio-day-to-dusk-dn-02.webp",
        alt: "Day-to-dusk — building with lit terraces and the facade in evening mode",
        beforeSrc: "/artwork/portfolio-day-to-dusk-dn-02-before.webp",
        beforeAlt: "The daytime view of the same building — the facade in daylight",
      },
      {
        src: "/artwork/portfolio-day-to-dusk-dn-03.webp",
        alt: "Day-to-dusk — villa with a lit terrace and facade lighting at dusk",
        beforeSrc: "/artwork/portfolio-day-to-dusk-dn-03-before.webp",
        beforeAlt: "The daytime view of the same villa — the exterior in daylight",
      },
      {
        src: "/artwork/portfolio-day-to-dusk-dn-04.webp",
        alt: "Day-to-dusk — building with facade lighting and a lit entrance at night",
    ...
    portfolioImages: [
      {
        ...
        beforeAlt: "The same living room before item removal — scattered items and clutter",
      },
      {
        src: "/artwork/portfolio-item-removal-ir-02.webp",
        alt: "Item removal — room tidied and ready for the photo",
        beforeSrc: "/artwork/portfolio-item-removal-ir-02-before.webp",
        beforeAlt: "The same room before item removal — excess items and clutter",
      },
      {
        src: "/artwork/portfolio-item-removal-ir-03.webp",
        alt: "Item removal — room cleared and ready for the photo",
        beforeSrc: "/artwork/portfolio-item-removal-ir-03-before.webp",
        beforeAlt: "The same room before item removal — scattered objects",
      },
      {
        src: "/artwork/portfolio-item-removal-ir-04.webp",
        alt: "Item removal — space cleared of excess elements for the photo",
        beforeSrc: "/artwork/portfolio-item-removal-ir-04-before.webp",
        beforeAlt: "The same space before item removal — visible excess elements and clutter",
      },
    ],
    variants: [
      {
