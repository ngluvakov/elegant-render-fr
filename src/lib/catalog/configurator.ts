...
export const CONFIGURATOR_CATEGORIES: ConfiguratorCategory[] = [
  ...
  {
    id: "apartment",
    label: "Stambeni kompleks",
    sectionLabel: "1.1 — Rendering",
    icon: "layers",
    description:
      "Progresivni popusti po broju jedinstvenih rasporeda na spratu",
    products: [
      {
        id: "apt-floor",
        ...
        includes: [
          "Kompletna izgradnja stana",
          "Do 10 opremljenih soba",
          "Osnova stana",
        ],
        addOns: [
          {
            id: "apt-layout-2",
            label: "2. jedinstveni raspored",
            description: "15% popusta — konstrukt postoji",
            priceEur: 145,
            priceType: "fixed",
            includedQty: 0,
            maxQty: 1,
          ...
          {
            id: "apt-layout-3",
            label: "3. jedinstveni raspored",
            description: "30% popusta — materijali definisani",
            priceEur: 120,
            priceType: "fixed",
            includedQty: 0,
            maxQty: 1,
          ...
          {
            id: "apt-layout-4",
            label: "4. jedinstveni raspored",
            description: "38% popusta — tok rada optimizovan",
            priceEur: 105,
            priceType: "fixed",
            includedQty: 0,
            maxQty: 1,
          ...
          {
            id: "apt-layout-5",
            label: "5+ jedinstveni raspored",
            description: "44% popusta — marginalan trud",
            priceEur: 95,
            priceType: "fixed",
            includedQty: 0,
            maxQty: Infinity,
          ...
          {
            id: "apt-duplicate",
            label: "Identična jedinica",
            description: "Isti raspored, druga pozicija",
            priceEur: 35,
            priceType: "fixed",
            includedQty: 0,
            maxQty: Infinity,
          ...
          {
            id: "apt-mirror",
            label: "Ogledalna jedinica",
            description: "Obrtanje geometrije + osvetljenje",
            priceEur: 25,
            priceType: "fixed",
            includedQty: 0,
            maxQty: Infinity,
          ...
          {
            id: "apt-floorplan",
            label: "Celokupna osnova sprata",
            description: "Svi stanovi + hodnici + zajednički prostori",
            priceEur: 46,
            priceType: "fixed",
            includedQty: 0,
            maxQty: 1,
          ...
          {
            id: "apt-repeat-floor",
            label: "Identičan sprat ponovljen",
            description: "Samo promene svetla/pogleda",
            priceEur: 75,
            priceType: "fixed",
            includedQty: 0,
            maxQty: Infinity,
    ...
    products: [
      {
        ...
        addOns: [
          ...
          },
          {
            id: "dtd-additional",
            label: "Dodatne slike",
            description: "Volumen popust nakon 10 slika",
            priceEur: 10,
            priceType: "fixed",
            includedQty: 0,
            maxQty: Infinity,
