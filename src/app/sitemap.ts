...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: SitemapEntry[] = [
    ...
    { path: "/legal/refunds", changeFrequency: "yearly", priority: 0.35 },
    { path: "/legal/withdrawal", changeFrequency: "yearly", priority: 0.35 },
    { path: "/legal/complaints", changeFrequency: "yearly", priority: 0.35 },
    { path: "/legal/delivery", changeFrequency: "yearly", priority: 0.35 },
